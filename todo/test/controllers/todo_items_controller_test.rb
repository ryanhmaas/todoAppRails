...
class TodoItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todo_item" do
    assert_difference('TodoItem.count') do
      post todo_items_url, params: { todo_item: { description: @todo_item.description, done: @todo_item.done, name: @todo_item.name } }
    end
  ...
  test "should update todo_item" do
    patch todo_item_url(@todo_item), params: { todo_item: { description: @todo_item.description, done: @todo_item.done, name: @todo_item.name } }
